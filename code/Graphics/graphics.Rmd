...
resultstheme <-
  ...
  theme(axis.title.x = element_text(family="Arial", size=10, colour = 'black', vjust = -0.5),
        ...
        axis.text.x = element_text(family="Arial", size= 8, colour = 'black', angle=0, vjust = 0),
        axis.text.y = element_text(family="Arial", size= 8, colour = 'black'))
...
abunplotdata$contrasts$contrast <- dplyr::recode(abunplotdata$contrasts$contrast,
       `Pinnacle - Offshore` = 'Pinnacle -\nOffshore  ',
       `Pinnacle - Nearshore` = 'Pinnacle -\nNearshore',
...
abunplotdata$contrasts <- abunplotdata$contrasts %>% 
  mutate(contrast = factor(contrast, levels= c("Pinnacle -\nOffshore  ", "Pinnacle -\nNearshore", "Offshore -\nNearshore")))
...
richplotresults <- ggplot(richplotdata$emmeans, aes(y=rate,  x=Reeftype)) +
  ...
  nulltheme+
  emmeanslist+
  annotate("text", x = 0.7, y = 7.7, label = "(C)")
...
allfig <- abunplotresults + abunplotcontrasts + biomplotresults + biomplotcontrasts +
                        richplotresults + richplotcontrasts + shanplotresults + shanplotcontrasts +
  plot_layout(ncol = 2)

ggsave(allfig, filename= '../../output/rfigures/all_fig.png', width=5,  height=8, dpi = 500 )
ggsave(allfig, filename= '../../output/rfigures/all_fig2.png', width=3,  height=5, dpi = 500 )
