...
This document ties together all the code for analysing predator fish data from the Kimbe Bay video survey data set. Specifically the following metrics are compared across the 3 reef types:

1. Predator abundance (BIOMASS???)
2. Predator community diversity indices (species richness and Shannon)
3. Predator community composition (PCA and biplot)

Following this, key drivers (environmental and habitat) of patterns identified are assessed using random forest and linear models.
