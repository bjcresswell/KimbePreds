...
```{r}
#             1      2       3       4       5        6
Coord_1 <- c(-2.6,	-4.2,	  -1.8,	  -2.6,	   1.1,	   -6.5)
Coord_2 <- c(-0.2,	0.2,	   1.1,	   0.5,	  -0.2,	   -0.7)
...
pred_nmds_plot <-
  ...
  geom_text(data = species.labels, aes(Coord_1*1.05, Coord_2, label = species), size = 4, fontface = "italic") + # Text for these           
...
ggsave(pred_nmds_plot, filename= '../../output/rfigures/prednmds2.pdf',  width = 174, height = 109, units = "mm", dpi = 600)
ggsave(pred_nmds_plot, filename= '../../output/rfigures/prednmds.svg',  device = 'svg' , width = 174, height = 109, units = "mm", dpi = 600)
...
pred_nmds_plot + 
  ...
  annotation_custom(
    ggplotGrob(predvenn), 
    xmin = -17, xmax =0.5, ymin = -1, ymax = 3)
...
ggsave(nmdsvenn, filename= '../../output/rfigures/nmdsvenn2.pdf',  width = 174, height = 109, units = "mm", dpi = 1000 )
